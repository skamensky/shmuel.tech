const lotsamarkdown=`![Showdown][sd-logo]
...
| DATE      | FUNDER      | DEAL NAME                      | FIRST | LAST   | PHONE     | EMAIL            | AMOUNT  | FACTOR | TERM | PAYMENT | STRUCTURE | COMMISSION % | COMMISSION $ |
|-----------|-------------|--------------------------------|-------|--------|-----------|------------------|---------|--------|------|---------|-----------|--------------|--------------|
| 3/15/2023 | Yellowstone | {{Deal Name/PORTAL LINK HERE}} | John  | Stamos | 123456789 | Jstamos@blah.com | $10,000 | 1.5    | 100  | $150    | Daily     | 10%          | $1,000       |

`,
   "lorem-ipsum": lotsamarkdown
}

export const load = ({ params }) => {
  return {
    title: `Blog post number ${params.slug}`,
    content: blurbs[params.slug],
  };
};
